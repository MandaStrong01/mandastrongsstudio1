    ...
    <div className="min-h-screen bg-gradient-to-br from-[#4c1d95]/20 via-black to-[#4c1d95]/20 text-white flex flex-col">
      <div className="flex-1 flex flex-col px-4 py-6">
        <div className="max-w-full w-full mx-auto flex-1 flex flex-col">
          <h1 className="text-3xl font-black text-[#a78bfa] mb-4 text-center">DOXY THE SCHOOL BULLY - Title & Text Creator</h1>
          ...
          <div className="grid grid-cols-12 gap-4 flex-1">
                ...
                <div className="aspect-video bg-black rounded-lg border border-[#6d28d9]/30 mb-4 flex items-center justify-center">
                  {selectedAsset ? (
                    <div className="text-center p-8">
                      <Type className="w-16 h-16 mx-auto mb-4 text-[#a78bfa]" />
            ...
            <div className="col-span-3 bg-black/30 backdrop-blur-sm rounded-2xl border border-[#6d28d9]/30 p-4 overflow-y-auto">
              <h2 className="text-xl font-bold mb-4 text-[#a78bfa]">TEXT TOOLS</h2>
              <div className="space-y-4">
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 bg-black border border-[#6d28d9]/50 rounded-lg text-white focus:outline-none focus:border-[#a78bfa] resize-none"
                    rows={4}
                  />
                </div>

                <div className="flex gap-2">
                  <button className="flex-1 p-2 bg-[#4c1d95]/30 hover:bg-[#4c1d95]/50 border border-[#6d28d9]/30 rounded-lg transition-all">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-10 bg-black border border-[#6d28d9]/50 rounded-lg cursor-pointer"
                  />
                </div>
                ...
                <div className="pt-4 border-t border-[#6d28d9]/30">
                  <label className="flex items-center gap-2 text-sm font-semibold mb-2">
                    <Minus className="w-4 h-4 text-[#a78bfa]" />
                  ...
                  <div className="mt-2">
                    ...
                    <input
                      ...
                      className="w-full h-8 bg-black border border-[#6d28d9]/50 rounded-lg cursor-pointer"
                    />
                  </div>
                </div>
                ...
                <div className="pt-4 border-t border-[#6d28d9]/30">
                  <label className="flex items-center gap-2 text-sm font-semibold mb-2">
                    <Circle className="w-4 h-4 text-[#a78bfa]" />
                    Shadow Controls
                  </label>
                  <div className="space-y-2">
                    <div>
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-3 border rounded-lg p-3 transition-all ${text3D ? 'bg-[#5b21b6] border-[#a78bfa]' : 'bg-[#4c1d95]/30 hover:bg-[#4c1d95]/50 border-[#6d28d9]/30'}`}
                >
                  <Cuboid className="w-5 h-5 text-[#a78bfa]" />
                  <span className="font-semibold">3D Text</span>
                </button>

                <button className="w-full flex items-center gap-3 bg-[#4c1d95]/30 hover:bg-[#4c1d95]/50 border border-[#6d28d9]/30 rounded-lg p-3 transition-all">
                  <Spline className="w-5 h-5 text-[#a78bfa]" />
                ...
                <button className="w-full flex items-center justify-center gap-2 bg-[#5b21b6] hover:bg-[#6d28d9] border border-[#6d28d9]/30 rounded-lg p-3 transition-all">
