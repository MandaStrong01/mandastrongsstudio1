    ...
    <div className="min-h-screen bg-gradient-to-br from-[#4c1d95]/20 via-black to-[#4c1d95]/20 text-white flex flex-col">
      <div className="flex-1 flex flex-col px-4 py-12">
        <div className="max-w-6xl w-full mx-auto">
          <h1 className="text-5xl font-black text-[#a78bfa] mb-4 text-center">Community Hub</h1>
          <p className="text-xl text-white/70 text-center mb-8">Connect, Share, and Inspire</p>

          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-black/30 backdrop-blur-sm rounded-2xl border border-[#6d28d9]/30 p-6 text-center hover:border-[#a78bfa] transition-all cursor-pointer">
              <Users className="w-12 h-12 mx-auto mb-4 text-[#a78bfa]" />
              <h3 className="text-xl font-bold mb-2">Community</h3>
              <p className="text-white/70">Join thousands of creators</p>
            </div>
            <div className="bg-black/30 backdrop-blur-sm rounded-2xl border border-[#6d28d9]/30 p-6 text-center hover:border-[#a78bfa] transition-all cursor-pointer">
              <Share2 className="w-12 h-12 mx-auto mb-4 text-[#a78bfa]" />
              <h3 className="text-xl font-bold mb-2">Showcase</h3>
              <p className="text-white/70">Share your projects</p>
            </div>
            <div className="bg-black/30 backdrop-blur-sm rounded-2xl border border-[#6d28d9]/30 p-6 text-center hover:border-[#a78bfa] transition-all cursor-pointer">
              <Star className="w-12 h-12 mx-auto mb-4 text-[#a78bfa]" />
          ...
          <div className="bg-black/30 backdrop-blur-sm rounded-2xl border border-[#6d28d9]/30 p-8 mb-8">
            <h2 className="text-2xl font-bold mb-6 text-[#a78bfa]">Featured Projects</h2>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <div key={i} className="bg-black/50 rounded-lg border border-[#6d28d9]/30 p-4 hover:border-[#a78bfa] transition-all">
                  <div className="aspect-video bg-[#4c1d95]/20 rounded-lg mb-3 flex items-center justify-center">
                    ...
                    <button
                      ...
                      className={`flex items-center gap-1 px-3 py-1 rounded-lg transition-all ${
                        likes[i]?.liked
                          ...
                          : 'bg-[#4c1d95]/30 text-white/70 hover:bg-[#4c1d95]/50'
                      }`}
                    >
