...
/**
 * MandaStrong Studio - Cinematic Production Design
 * Implements Page 1-2 video background, oval avatar, and Page 3 styling.
 */
export default function MandaStrongStudio() {
  const videoRef = useRef<HTMLVideoElement>(null);

  // Auto-play with sound enabled logic
  useEffect(() => {
    if (videoRef.current) {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-black">
      ...
      {/* BACKGROUND: Ocean video with audio until leaving Page 2 */}
      ...
      {/* HEADER: Bold black cinematic style */}
      ...
      {/* OVAL AVATAR: Bottom-right oval shape with white play button */}
