    ...
    <div className="min-h-screen bg-gradient-to-br from-[#2d1554]/20 via-black to-[#2d1554]/20 text-white flex flex-col">
      <div className="flex-1 flex flex-col px-4 py-6">
        <div className="max-w-full w-full mx-auto flex-1 flex flex-col">
          <h1 className="text-3xl font-black text-[#7c3aed] mb-4 text-center">DOXY THE SCHOOL BULLY - Color Grade / Visual FX</h1>
          ...
          <div className="grid grid-cols-12 gap-4 flex-1">
                ...
                <div className="aspect-video bg-black rounded-lg border border-[#2d1554]/30 mb-4 flex items-center justify-center">
                  {selectedAsset ? (
                    <div className="text-center p-8">
                      <Palette className="w-16 h-16 mx-auto mb-4 text-[#7c3aed]" />
            ...
            <div className="col-span-3 bg-black/30 backdrop-blur-sm rounded-2xl border border-[#2d1554]/30 p-4 overflow-y-auto">
              <h2 className="text-xl font-bold mb-4 text-[#7c3aed]">COLOR & FX TOOLS</h2>
              <div className="space-y-4">
                ...
                <div>
                  <label className="flex items-center gap-2 text-sm font-semibold mb-2">
                    <Contrast className="w-4 h-4 text-[#7c3aed]" />
                    Contrast: {contrast}%
                  </label>
                  <input
                    type="range"
                ...
                <div>
                  <label className="flex items-center gap-2 text-sm font-semibold mb-2">
                    <Droplet className="w-4 h-4 text-[#7c3aed]" />
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-3 border rounded-lg p-3 transition-all ${denoise ? 'bg-[#2d1554] border-[#7c3aed]' : 'bg-[#2d1554]/30 hover:bg-[#2d1554]/50 border-[#2d1554]/30'}`}
                >
                ...
                <button className="w-full flex items-center gap-3 bg-[#2d1554]/30 hover:bg-[#2d1554]/50 border border-[#2d1554]/30 rounded-lg p-3 transition-all">
                  <Circle className="w-5 h-5 text-[#7c3aed]" />
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-3 border rounded-lg p-3 transition-all ${splitView ? 'bg-[#2d1554] border-[#7c3aed]' : 'bg-[#2d1554]/30 hover:bg-[#2d1554]/50 border-[#2d1554]/30'}`}
                >
                  <SplitSquareHorizontal className="w-5 h-5 text-[#7c3aed]" />
                ...
                <div className="pt-4 border-t border-[#2d1554]/30 flex gap-2">
                  <button className="flex-1 flex items-center justify-center gap-2 bg-[#2d1554] hover:bg-[#2d1554] rounded-lg p-3 transition-all">
