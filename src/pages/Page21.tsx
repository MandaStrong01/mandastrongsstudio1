      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-12">
        <div className="max-w-6xl w-full text-center">
          <div className="bg-black/30 backdrop-blur-sm rounded-2xl border border-[#2d1554]/30 p-8 mb-8">
            <div className="aspect-video bg-black rounded-lg overflow-hidden border border-[#2d1554]/30 mb-6">
              <video
                autoPlay
                loop
                muted
            ...
            <h1 className="text-6xl md:text-7xl font-black mb-8 tracking-tight text-[#7c3aed]">
              THAT'S ALL FOLKS!
            </h1>

            <div className="max-w-4xl mx-auto mb-8 text-center bg-gradient-to-br from-[#2d1554]/40 to-black/40 rounded-2xl p-12 border-2 border-[#7c3aed]/50 shadow-2xl">
              <h2 className="text-3xl text-[#7c3aed] font-bold mb-6">A Special Thank You</h2>
              ...
              <p className="text-lg text-[#7c3aed] font-semibold leading-relaxed">
            ...
            <button
              ...
              className="w-full max-w-2xl mx-auto mb-6 bg-black/50 hover:bg-[#2d1554]/40 rounded-xl p-6 border border-[#2d1554]/30 transition-all cursor-pointer group"
            >
              <div className="flex items-center justify-center gap-3 mb-3">
                <BookOpen className="w-6 h-6 text-[#7c3aed] group-hover:scale-110 transition-transform" />
                <h2 className="text-2xl font-bold text-[#7c3aed]">Full User Guide To MandaStrong Studio</h2>
              </div>
              <p className="text-sm text-white/60">Click to access the complete guide</p>
            </button>

            <div className="max-w-3xl mx-auto mb-8 bg-gradient-to-br from-black/50 to-[#2d1554]/30 rounded-2xl p-8 border-2 border-[#2d1554]/40 shadow-xl">
              <h3 className="text-2xl font-bold text-[#7c3aed] mb-6 text-center">About Our Mission</h3>
              <div className="space-y-4 text-white/90 leading-relaxed">
                <p className="text-lg">
                  <span className="font-bold text-[#7c3aed]">MandaStrong Studio</span> is more than a filmmaking platform.
                ...
                <div className="bg-[#2d1554]/40 rounded-xl p-6 border border-[#7c3aed]/30 mt-6">
                  <p className="text-xl font-semibold text-[#7c3aed] mb-3 text-center">Supporting Our Heroes</p>
                  <p className="text-lg text-center">
                    <span className="font-bold text-white">100% of all proceeds</span> from our Etsy Store fundraiser
                    are donated directly to <span className="font-bold text-[#7c3aed]">Veterans Mental Health Services</span>,
                ...
                <p className="text-lg text-center mt-6">
                  ...
                  <a
                    ...
                    className="text-[#7c3aed] hover:text-[#7c3aed] underline font-bold transition-colors"
                  >
            ...
            <div className="bg-black/50 rounded-2xl p-8 border border-[#2d1554]/30 mb-6 hidden">
              <div className="flex items-center justify-center gap-3 mb-6">
                <BookOpen className="w-8 h-8 text-[#7c3aed]" />
                <h2 className="text-3xl font-bold text-[#7c3aed]">Full User Guide To MandaStrong Studio</h2>
              </div>
              <div className="grid md:grid-cols-2 gap-6 text-left">
                <div className="space-y-3">
                  <h3 className="font-bold text-[#7c3aed] mb-2">Navigation</h3>
                ...
                <div className="space-y-3">
                  <h3 className="font-bold text-[#7c3aed] mb-2">Editing & Export</h3>
                ...
                <div className="space-y-3">
                  <h3 className="font-bold text-[#7c3aed] mb-2">Tools & Features</h3>
                ...
                <div className="space-y-3">
                  <h3 className="font-bold text-[#7c3aed] mb-2">Subscription Plans</h3>
