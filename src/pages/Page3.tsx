        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12 max-w-5xl mx-auto">
          ...
          >
            <div className="text-center">
              ...
              <p className="text-sm text-white/80">Essential features for beginners</p>
            </div>
          </button>
          ...
          >
            <div className="text-center">
              ...
              <p className="text-sm text-white/80">Advanced tools for professionals</p>
            </div>
          </button>
          ...
          >
            <div className="text-center">
              ...
              <p className="text-sm text-white/80">Complete studio experience</p>
            </div>
          </button>
        </div>
