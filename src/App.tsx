...
function App() {
  ...
  const handleGenerateClip = () => {
    ...
    // Simulate generation - replace with your actual backend call
    setTimeout(() => {
    ...
    <div className="studio-app">
      ...
      {currentPage === 8 && (
        <div className="page">
          ...
          {/* Upload Reference Button - Normal size, directly above Generate */}
          <div className="input-group">
...
export default App;import { useState, ChangeEvent } from 'react';
import './App.css';
