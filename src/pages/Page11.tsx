    ...
    <div className="min-h-screen bg-gradient-to-br from-[#2d1554]/20 via-black to-[#2d1554]/20 text-white flex flex-col">
      <div className="flex-1 flex flex-col px-4 py-6">
        <div className="max-w-full w-full mx-auto flex-1 flex flex-col">
          <h1 className="text-2xl md:text-3xl font-black text-[#7c3aed] mb-4 text-center">Editor Dashboard</h1>

          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 flex-1">
            <div
              className={`relative lg:col-span-3 bg-black/30 backdrop-blur-sm rounded-2xl border p-4 transition-all ${
                isDragging
                  ? 'border-[#7c3aed] border-4 bg-[#2d1554]/40'
                  : 'border-[#2d1554]/30'
              }`}
            ...
            >
              <div className="mb-4">
                <h2 className="text-xl font-bold text-[#7c3aed] mb-2">MEDIA BOX</h2>
                <div className="bg-[#2d1554]/30 border border-[#7c3aed]/40 rounded-lg p-3 mb-2">
                  <p className="text-sm text-[#7c3aed] font-semibold mb-1">Select Asset / Drag & Drop</p>
                  <p className="text-xs text-white/80 leading-relaxed">
                    Click any asset below to preview it, or drag files directly into this box to upload.
                  </p>
                </div>
                <div className="bg-gradient-to-r from-[#2d1554]/40 to-[#2d1554]/40 border border-[#7c3aed]/50 rounded-lg p-3">
                  <p className="text-sm text-[#7c3aed] font-bold text-center animate-pulse">
              ...
              {isDragging && (
                <div className="absolute inset-4 bg-[#2d1554]/60 backdrop-blur-sm border-4 border-dashed border-[#7c3aed] rounded-2xl flex items-center justify-center z-10 pointer-events-none">
                  <div className="text-center">
                    <Upload className="w-16 h-16 mx-auto mb-3 text-[#7c3aed] animate-bounce" />
                    <p className="text-xl font-bold text-[#7c3aed]">Drop files here</p>
                    <p className="text-sm text-[#7c3aed] mt-2">Images auto-compress for faster uploads</p>
                  </div>
                </div>
              )}

              {uploading && (
                <div className="absolute inset-0 bg-gradient-to-br from-black/95 via-[#2d1554]/90 to-black/95 backdrop-blur-md rounded-2xl flex items-center justify-center z-20 p-8">
                  <div className="w-full max-w-lg">
                    <div className="text-center mb-6">
                      <Loader2 className="w-16 h-16 mx-auto mb-3 text-[#7c3aed] animate-spin" />
                      <p className="text-2xl font-bold text-white mb-1">Fast Upload in Progress</p>
                      <p className="text-sm text-[#7c3aed]">Optimizing and uploading your files</p>
                    </div>
                    {Object.keys(uploadProgress).length > 0 ? (
                      <div className="space-y-3 max-h-80 overflow-y-auto pr-2 custom-scrollbar">
                        {Object.entries(uploadProgress).map(([fileName, progress]) => (
                          <div key={fileName} className="bg-black/40 backdrop-blur-sm border border-[#2d1554]/30 rounded-lg p-4 shadow-lg">
                            <div className="flex items-center justify-between mb-2">
                              <p className="text-sm text-white/95 font-medium truncate flex-1 mr-3">{fileName}</p>
                              <p className="text-sm font-bold text-[#7c3aed] min-w-[45px] text-right">{Math.round(progress)}%</p>
                            </div>
                            <div className="w-full bg-purple-950/50 rounded-full h-2.5 overflow-hidden">
                              <div
                                className="bg-gradient-to-r from-[#2d1554] via-[#2d1554] to-[#7c3aed] h-2.5 rounded-full transition-all duration-200 ease-out shadow-lg shadow-[#2d1554]/50"
                      ...
                      <div className="text-center">
                        <p className="text-[#7c3aed] animate-pulse">Preparing files...</p>
                      </div>
                    )}
                  </div>
                </div>
              ...
              <div className="space-y-3 mb-4">
                <button
                  ...
                  disabled={uploading}
                  className="w-full bg-gradient-to-br from-[#2d1554]/30 to-black/50 backdrop-blur-xl border-2 border-[#2d1554]/60 hover:border-[#7c3aed] hover:from-[#2d1554]/40 hover:to-black/60 disabled:opacity-50 disabled:cursor-not-allowed px-4 py-4 rounded-xl transition-all text-white font-semibold"
                >
              ...
              <div className="bg-[#2d1554]/20 border border-[#2d1554]/30 rounded-lg p-3 mb-4">
                    ...
                    return (
                      <div key={asset.id} className="relative group">
                        ...
                        <button
                          ...
                          className="absolute top-2 right-2 p-1 bg-[#2d1554] hover:bg-[#2d1554] rounded-full opacity-0 group-hover:opacity-100 transition-all"
                          title="Delete asset"
                        >
            ...
            <div className="lg:col-span-6 bg-black/30 backdrop-blur-sm rounded-2xl border border-[#2d1554]/30 p-4 flex flex-col">
              <h2 className="text-xl font-bold mb-4 text-[#7c3aed]">VIEWER</h2>
              <div className="flex-1 flex flex-col">
                <div className="aspect-video bg-black rounded-lg border border-[#2d1554]/30 mb-4 flex items-center justify-center overflow-hidden">
                  {selectedAsset ? (
                    isMediaAsset(selectedAsset) ? (
                      selectedAsset.asset_type === 'image' ? (
                        ...
                        <div className="text-center p-8">
                          <File className="w-16 h-16 mx-auto mb-4 text-[#7c3aed]" />
            ...
            <div className="lg:col-span-3 bg-black/30 backdrop-blur-sm rounded-2xl border border-[#2d1554]/30 p-4">
              <h2 className="text-xl font-bold mb-4 text-[#7c3aed]">CONTROLS</h2>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 text-xs bg-[#2d1554] hover:bg-[#2d1554] px-2 py-1 rounded transition-all"
                    >
                      <Sparkles className="w-3 h-3" />
                      AI Help
                    </button>
                  </div>
                  <div className="bg-[#2d1554]/20 border border-[#2d1554]/30 rounded-lg p-3">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-[#7c3aed]">{formatTime(currentTime)}</div>
                    ...
                    <input
                      ...
                      className="w-full h-2 bg-[#2d1554]/50 rounded-lg appearance-none cursor-pointer mt-3"
                    />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-6">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 bg-[#2d1554] text-white font-bold px-6 sm:px-8 py-4 rounded-lg text-base sm:text-lg hover:bg-[#2d1554] transition-all disabled:bg-[#2d1554] disabled:cursor-not-allowed"
            >
              {generating ? (
                <>
      ...
      {showScriptModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 px-4">
          <div className="bg-gradient-to-br from-[#2d1554]/90 to-black/90 border-2 border-[#7c3aed] rounded-2xl p-8 max-w-md w-full shadow-2xl">
            <div className="text-center mb-6">
              <Sparkles className="w-16 h-16 mx-auto mb-4 text-[#7c3aed]" />
            ...
            <div className="flex gap-4">
              <button
                ...
                className="flex-1 bg-black hover:bg-gray-900 text-white font-bold py-4 px-6 rounded-lg text-lg transition-all border border-[#2d1554]/50"
              >
                NO
              </button>
              <button
                onClick={() => handleScriptResponse(true)}
                className="flex-1 bg-[#2d1554] hover:bg-[#2d1554] text-white font-bold py-4 px-6 rounded-lg text-lg transition-all"
              >
                YES
              </button>
            </div>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 px-4">
          <div className="bg-gradient-to-br from-[#2d1554]/90 to-black/90 border-2 border-[#7c3aed] rounded-2xl p-8 max-w-md w-full shadow-2xl">
            <div className="text-center mb-6">
              ...
              <div className="mt-4 bg-[#2d1554]/30 border border-[#2d1554]/30 rounded-lg p-3">
            ...
            <div className="flex gap-4">
              <button
                ...
                className="flex-1 bg-black hover:bg-gray-900 text-white font-bold py-4 px-6 rounded-lg text-lg transition-all border border-[#2d1554]/50 disabled:opacity-50"
              >
                Cancel
              </button>
              <button
                ...
                disabled={aiCalculating}
                className="flex-1 bg-[#2d1554] hover:bg-[#2d1554] text-white font-bold py-4 px-6 rounded-lg text-lg transition-all disabled:bg-[#2d1554] flex items-center justify-center gap-2"
              >
                {aiCalculating ? (
                  <>
                    <div className="animate-spin w-5 h-5 border-2 border-white border-t-transparent rounded-full"></div>
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 px-4">
          <div className="bg-gradient-to-br from-[#2d1554]/90 to-black/90 border-2 border-[#7c3aed] rounded-2xl p-8 max-w-lg w-full shadow-2xl">
            <div className="text-center mb-6">
              <div className="w-20 h-20 mx-auto mb-4 bg-[#2d1554] rounded-full flex items-center justify-center">
              ...
              {generatedOutput && (
                <div className="bg-black/50 border border-[#7c3aed]/30 rounded-lg p-4 mb-4 text-left">
            ...
            <button
              ...
              className="w-full bg-[#2d1554] hover:bg-[#2d1554] text-white font-bold py-4 px-6 rounded-lg text-lg transition-all"
            >
              Done
            </button>
          </div>
