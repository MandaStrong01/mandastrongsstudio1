...
import { Sparkles, Film, Play, Bot, Menu, Check, Search, X, Video, Clapperboard, Music } from 'lucide-react';
...
export default function App() {
  ...
  // OWNER/ADMIN BYPASS: woolleya129@gmail.com
  const handleLogin = () => {
    if (email.toLowerCase() === 'woolleya129@gmail.com') {
      setCurrentPage(11); // Immediate bypass to Editor Suite for Admin
    } else {
      setCurrentPage(4);
    }
  };
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case 3: // PLANS OVERLAY
        return (
          <div className="min-h-screen bg-black/90 text-white p-8 overflow-y-auto">
            <div className="max-w-7xl mx-auto mb-40 pt-10">
              <div className="grid md:grid-cols-2 gap-8 mb-20">
                ...
                <div className="bg-purple-950/20 border-2 border-purple-600 rounded-3xl p-10 flex flex-col justify-center text-center"><h2 className="text-3xl font-black mb-8 italic uppercase text-purple-500">Register</h2><button className="w-full bg-purple-600 py-4 rounded-xl font-black text-xl uppercase italic shadow-lg">Create Account</button></div>
              </div>
            ...
            <Nav p={2} n={4} />
            <div className="fixed bottom-4 left-1/2 -translate-x-1/2 w-full text-center text-gray-600 text-[10px] font-black uppercase tracking-widest">MandaStrong1 2026 ~ Author Of Doxy The School Bully ~ MandaStrong1.Etsy.com</div>
          </div>
        );
      ...
      case 14: // ENHANCEMENT STUDIO (3-HOUR SLIDER)
        return (
      ...
      default: return <div className="min-h-screen bg-black flex flex-col items-center justify-center text-white"><h1 className="text-5xl font-black text-purple-500 uppercase italic mb-10">Module {currentPage}</h1><Nav p={currentPage - 1} n={currentPage + 1} /></div>;
    }
  };
