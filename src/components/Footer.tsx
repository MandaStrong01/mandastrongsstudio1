...
export default function Footer({ showDoxyCredit = false }: FooterProps) {
  return (
    <footer className="w-full py-6 px-4 text-center bg-[#2d1554]/20 border-t border-[#2d1554]/30">
      <p className="text-white/80 text-xs sm:text-sm break-words leading-relaxed">
        ...
        <a
          ...
          className="text-[#7c3aed] hover:text-[#7c3aed] underline font-semibold transition-colors"
        >
