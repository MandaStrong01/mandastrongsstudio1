...
export default function App() {
      ...
      <div className="bg-black border-2 border-[#7c3aed] rounded-3xl max-w-3xl w-full p-8" onClick={(e) => e.stopPropagation()}>
        <div className="flex justify-between items-start mb-6">
          <div>
            ...
            <p className="text-[#a78bfa]">Professional AI-powered tool for creating amazing content</p>
          </div>
          <button onClick={onClose} className="text-[#a78bfa] hover:text-white text-2xl">✕</button>
        </div>
        <div className="grid grid-cols-3 gap-4 mb-6">
          <button className="bg-[#5b21b6] hover:bg-[#6d28d9] border-2 border-[#7c3aed] rounded-2xl p-6 transition-all">
            <Upload size={40} className="mx-auto mb-3 text-[#a78bfa]" />
            <p className="font-bold text-white">Upload</p>
          </button>
          <button className="bg-[#5b21b6] hover:bg-[#6d28d9] border-2 border-[#7c3aed] rounded-2xl p-6 transition-all">
            <FileText size={40} className="mx-auto mb-3 text-[#a78bfa]" />
            <p className="font-bold text-white">Paste</p>
          </button>
          <button className="bg-[#5b21b6] hover:bg-[#6d28d9] border-2 border-[#7c3aed] rounded-2xl p-6 transition-all">
            <Sparkles size={40} className="mx-auto mb-3 text-[#a78bfa]" />
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case 1:
        return (
          <div className="min-h-screen bg-[#4c1d95] flex flex-col justify-between px-6 py-8">
            <div className="flex justify-start">
              <button className="bg-[#5b21b6] hover:bg-[#6d28d9] text-[#a78bfa] px-5 py-2 rounded-xl text-sm font-bold border border-[#7c3aed] flex items-center gap-2 transition-all">
                <Menu size={16} /> Quick Access
              </button>
            </div>
            <div className="flex flex-col items-center justify-center text-center flex-1 py-12">
              <h1 className="text-6xl md:text-8xl font-black text-[#a78bfa] leading-tight mb-8" style={{ fontFamily: 'Impact, Arial Black, sans-serif' }}>
                MANDASTRONG STUDIO
              </h1>
              <p className="text-2xl md:text-3xl text-[#a78bfa] font-bold italic">
                Welcome To An All In One Make Your Own Longer Movies!
              </p>
            </div>
            <div className="flex gap-4 justify-center pb-4">
              <button onClick={() => setCurrentPage(2)} className="bg-[#5b21b6] hover:bg-[#6d28d9] text-[#a78bfa] px-8 py-3 rounded-xl text-base font-bold border border-[#7c3aed] transition-all">Next</button>
              <button onClick={() => setCurrentPage(3)} className="bg-[#5b21b6] hover:bg-[#6d28d9] text-[#a78bfa] px-8 py-3 rounded-xl text-base font-bold border border-[#7c3aed] transition-all">Login</button>
              <button onClick={() => setCurrentPage(3)} className="bg-[#5b21b6] hover:bg-[#6d28d9] text-[#a78bfa] px-8 py-3 rounded-xl text-base font-bold border border-[#7c3aed] transition-all">Register</button>
            </div>
            <GrokBtn />
          </div>
        );
      ...
      case 2:
        return (
          <div className="min-h-screen bg-[#4c1d95] text-white flex flex-col items-center justify-between px-4 py-12">
            <div className="flex-1 flex flex-col items-center justify-center text-center max-w-5xl">
              <div className="flex justify-center mb-8">
                <Sparkles size={80} className="text-[#a78bfa]" />
              </div>
              <h1 className="text-7xl md:text-8xl font-bold mb-8 text-white">MANDASTRONG'S<br/>STUDIO</h1>
              <p className="text-4xl md:text-5xl mb-4 text-[#a78bfa] font-bold italic">Make Amazing Family Movies</p>
              <p className="text-4xl md:text-5xl text-[#a78bfa] font-bold italic">& Bring Dreams To Life!</p>
            </div>
      ...
      case 3:
        return (
          <div className="min-h-screen bg-[#4c1d95] text-white p-6">
            <div className="grid grid-cols-2 gap-6 mb-6">
              <div className="border-2 border-[#7c3aed] rounded-2xl p-6">
                <h2 className="text-3xl font-bold mb-6 text-white">Login</h2>
                <div className="space-y-4">
                  <input type="email" placeholder="Email" className="w-full bg-black border border-[#7c3aed] rounded-xl px-4 py-3 text-white placeholder-[#5b21b6] outline-none focus:border-[#a78bfa]" />
                  <input type="password" placeholder="Password" className="w-full bg-black border border-[#7c3aed] rounded-xl px-4 py-3 text-white placeholder-[#5b21b6] outline-none focus:border-[#a78bfa]" />
              ...
              <div className="border-2 border-[#7c3aed] rounded-2xl p-6">
                ...
                <div className="space-y-4">
                  <input type="text" placeholder="Name" className="w-full bg-black border border-[#7c3aed] rounded-xl px-4 py-3 text-white placeholder-[#5b21b6] outline-none focus:border-[#a78bfa]" />
                  <input type="email" placeholder="Email" className="w-full bg-black border border-[#7c3aed] rounded-xl px-4 py-3 text-white placeholder-[#5b21b6] outline-none focus:border-[#a78bfa]" />
                  <input type="password" placeholder="Password" className="w-full bg-black border border-[#7c3aed] rounded-xl px-4 py-3 text-white placeholder-[#5b21b6] outline-none focus:border-[#a78bfa]" />
            ...
            <div className="grid grid-cols-3 gap-6 mb-6">
              {[
                ...
                <div key={plan.name} className="border-2 border-[#7c3aed] rounded-2xl p-6 relative">
                  ...
                  <p className="text-4xl font-black mb-4 text-white">{plan.price}<span className="text-lg text-[#a78bfa]">/mo</span></p>
                  <ul className="space-y-2 mb-6">
                    {plan.features.map(f => <li key={f} className="flex gap-2 text-sm text-[#a78bfa]"><Check size={16} className="text-[#6d28d9] flex-shrink-0 mt-0.5" />{f}</li>)}
                  </ul>
            ...
            <p className="text-[#4c1d95] text-xs text-center mt-4">MandaStrong1 2025 ~ Author Of Doxy The School Bully ~ MandaStrong1.Etsy.com</p>
            <GrokBtn />
          </div>
        );
        ...
        return (
          <div className="min-h-screen bg-[#4c1d95] text-white p-6">
            <div className="flex justify-between items-center mb-6">
              <div>
                <h1 className="text-4xl font-bold text-[#a78bfa]">AI TOOL BOARD</h1>
                <p className="text-[#a78bfa] mt-1">{names[currentPage]} - 120 Professional AI Tools</p>
              </div>
            ...
            <div className="mb-6 max-w-xl relative">
              <Search size={22} className="absolute left-4 top-1/2 transform -translate-y-1/2 text-[#a78bfa]" />
              <input type="text" placeholder="Search for tools..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="w-full bg-[#2e1065] border-2 border-[#7c3aed] rounded-2xl pl-12 pr-6 py-4 text-white placeholder-[#a78bfa] outline-none focus:border-[#a78bfa] transition-all" />
            </div>
            <div className="bg-[#2e1065]/50 border-2 border-[#7c3aed] rounded-3xl p-6 mb-6 h-[500px] overflow-y-auto custom-scrollbar">
              <div className="grid grid-cols-4 gap-3">
                {filtered.map((tool,i) => (
                  <button key={i} onClick={() => setSelectedTool(tool)} className="bg-[#4c1d95] border border-[#7c3aed] hover:border-[#a78bfa] rounded-xl p-4 text-center transition-all hover:scale-105 hover:bg-[#5b21b6]">
      ...
      case 10:
        return (
          <div className="min-h-screen bg-[#4c1d95] text-white flex flex-col px-8 py-6">
      ...
      case 11:
        return (
          <div className="min-h-screen bg-[#4c1d95] text-white p-8">
            <div className="flex justify-between items-center mb-8">
              <h1 className="text-4xl font-bold text-[#a78bfa]">MEDIA LIBRARY</h1>
            ...
            <label className="block border-4 border-dashed border-[#7c3aed] hover:border-[#a78bfa] rounded-3xl p-12 text-center mb-8 cursor-pointer transition-all bg-[#2e1065]/30">
              <Upload size={64} className="text-[#a78bfa] mx-auto mb-4" />
              <p className="text-2xl font-bold text-[#a78bfa] mb-2">Drag & Drop Files Here</p>
              <p className="text-[#a78bfa] mb-4">Upload Videos, Audio, Images • All Formats Supported</p>
              <input type="file" className="hidden" multiple accept="video/*,audio/*,image/*" />
            </label>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {['Movie_Part1.mp4','Movie_Part2.mp4','Background_Music.mp3','Voice_Over.mp3','Scene1.png','Scene2.png'].map((file,i) => (
                <div key={i} className="bg-[#4c1d95] border-2 border-[#7c3aed] rounded-2xl p-4 hover:border-[#a78bfa] transition-all">
                  <Film size={40} className="text-[#a78bfa] mb-2" />
                  <p className="font-bold text-sm mb-3 truncate text-[#a78bfa]">{file}</p>
      ...
      case 12:
        return (
          <div className="min-h-screen bg-[#4c1d95] text-white p-8">
            <h1 className="text-4xl font-bold text-[#a78bfa] mb-8 text-center">TIMELINE EDITOR</h1>
            <div className="grid grid-cols-4 gap-4 mb-8">
              <div className="col-span-1 bg-[#2e1065] border-2 border-[#7c3aed] rounded-2xl p-4">
                <h3 className="font-bold text-[#a78bfa] mb-4">MEDIA LIBRARY</h3>
                {['Video1.mp4','Audio1.mp3','Image1.png','Video2.mp4'].map((f,i) => (
                  <div key={i} className="bg-[#4c1d95] rounded-xl p-3 mb-2 text-sm cursor-pointer hover:bg-[#5b21b6] transition-all text-[#a78bfa] border border-[#7c3aed]">{f}</div>
                ))}
              </div>
              <div className="col-span-3 bg-[#2e1065] border-2 border-[#7c3aed] rounded-2xl p-4">
                ...
                <p className="text-[#a78bfa] text-sm mb-4">Timeline Preview — Drag media from library to tracks below</p>
                <div className="space-y-3">
                  {['VIDEO TRACK 1','AUDIO TRACK 1','TEXT TRACK 1'].map((track,i) => (
                    <div key={i} className="flex items-center gap-4">
                      <span className="text-[#a78bfa] text-sm w-28 font-bold">{track}</span>
                      <div className="flex-1 bg-[#4c1d95] h-12 rounded-lg border-2 border-[#7c3aed] hover:border-[#a78bfa] transition-all cursor-pointer flex items-center px-4">
                        <span className="text-[#6d28d9] text-xs">Drop media here or click to add</span>
                      </div>
                    </div>
                  ))}
                </div>
      ...
      case 13:
        return (
          <div className="min-h-screen bg-[#4c1d95] text-white p-8">
            <h1 className="text-4xl font-bold text-[#a78bfa] mb-8 text-center">AUDIO MIXER</h1>
            <div className="bg-[#2e1065] border-2 border-[#7c3aed] rounded-3xl p-8 mb-6">
              <div className="grid grid-cols-4 gap-6">
                {[{ch:'MUSIC',vol:75},{ch:'VOICE',vol:85},{ch:'SFX',vol:60},{ch:'MASTER',vol:80}].map((c,i) => (
                  <div key={i} className={`bg-[#4c1d95] rounded-2xl p-6 border-2 ${i===3?'border-[#a78bfa]':'border-[#7c3aed]'}`}>
                    <p className="text-center font-bold text-[#a78bfa] mb-4 text-xl">{c.ch}</p>
      ...
      case 14:
        return (
          <div className="min-h-screen bg-[#4c1d95] text-white p-8">
            <h1 className="text-4xl font-bold text-[#a78bfa] mb-8 text-center">SETTINGS & CONFIGURATION</h1>
            <div className="space-y-6 max-w-4xl mx-auto">
              <div className="bg-[#2e1065] border-2 border-[#7c3aed] rounded-3xl p-8">
                <h3 className="text-[#a78bfa] font-bold text-xl mb-6">Video Settings</h3>
                <div className="space-y-4">
                  <div><label className="block mb-2 text-[#a78bfa] font-bold">Movie Title</label><input defaultValue="My Awesome Movie" className="w-full bg-[#4c1d95] border-2 border-[#7c3aed] rounded-xl px-4 py-3 text-white outline-none focus:border-[#a78bfa] transition-all" /></div>
                  <div className="grid grid-cols-3 gap-4">
                    <div><label className="block mb-2 text-[#a78bfa] font-bold">Resolution</label><select className="w-full bg-[#4c1d95] border-2 border-[#7c3aed] rounded-xl px-4 py-3 text-white outline-none"><option>1920x1080 (Full HD)</option><option>3840x2160 (4K)</option><option>7680x4320 (8K)</option></select></div>
                    <div><label className="block mb-2 text-[#a78bfa] font-bold">Frame Rate</label><select className="w-full bg-[#4c1d95] border-2 border-[#7c3aed] rounded-xl px-4 py-3 text-white outline-none"><option>30 fps</option><option>60 fps</option><option>24 fps</option></select></div>
                    <div><label className="block mb-2 text-[#a78bfa] font-bold">Duration (min)</label><select className="w-full bg-[#4c1d95] border-2 border-[#7c3aed] rounded-xl px-4 py-3 text-white outline-none"><option>30</option><option>60</option><option>90</option><option>120</option><option>180</option></select></div>
                  </div>
                </div>
              </div>
            </div>
      ...
      case 15:
        return (
          <div className="min-h-screen bg-[#4c1d95] text-white p-8">
            <h1 className="text-4xl font-bold text-[#a78bfa] mb-8 text-center">TUTORIALS & LEARNING CENTER</h1>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <div className="bg-[#2e1065] border-2 border-[#7c3aed] rounded-3xl overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-[#a78bfa] text-sm mb-3">Welcome to MandaStrong Studio! This tutorial shows you how to access all tools.</p>
                ...
                <div className="bg-[#2e1065] border-2 border-[#7c3aed] rounded-3xl p-6">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <button key={i} className={`w-full bg-[#4c1d95] hover:bg-[#5b21b6] rounded-xl p-4 text-left transition-all border-2 ${i===0?'border-[#a78bfa]':'border-[#7c3aed]'}`}>
                        <p className="font-bold text-sm mb-1 text-white">{t.title}</p>
                        <p className="text-[#a78bfa] text-xs">⏱ {t.time} • {t.level}</p>
                      </button>
                    ))}
                  </div>
                </div>
      ...
      case 16:
        return (
          <div className="min-h-screen bg-[#4c1d95] text-white p-8">
            <h1 className="text-4xl font-bold text-[#a78bfa] mb-8 text-center">EXPORT CENTER</h1>
            <div className="max-w-5xl mx-auto">
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <div className="bg-[#2e1065] border-2 border-[#7c3aed] rounded-3xl p-8">
                  <h3 className="text-2xl font-bold text-white mb-6">Export Settings</h3>
                  <div className="space-y-6">
                    <div><label className="block mb-3 text-[#a78bfa] font-bold">Resolution</label>
                      <div className="grid grid-cols-3 gap-3">
                        {['4K','1080p','720p'].map(r => <button key={r} className={`px-6 py-4 rounded-xl font-bold transition-all ${r==='4K'?'bg-[#5b21b6] text-white border-2 border-[#a78bfa]':'bg-[#4c1d95] text-[#a78bfa] border-2 border-[#7c3aed]'}`}>{r}</button>)}
                      </div>
                    </div>
                    <div><label className="block mb-3 text-[#a78bfa] font-bold">Format</label>
                    ...
                    <button className="w-full bg-[#5b21b6] hover:bg-[#6d28d9] py-4 rounded-2xl font-bold text-xl transition-all border-2 border-[#a78bfa]">Start Rendering</button>
                  </div>
                </div>
                <div className="bg-[#2e1065] border-2 border-[#7c3aed] rounded-3xl p-8 flex flex-col items-center justify-center">
                  <Film size={80} className="text-[#a78bfa] mb-6" />
                  <h3 className="text-3xl font-bold mb-4 text-white">Ready to Export</h3>
                  <p className="text-[#a78bfa] text-center mb-6">Your movie will be rendered and auto-saved to Editor's Choice screen</p>
                  <div className="text-center">
                    <p className="text-6xl font-black text-white mb-2">90</p>
                    <p className="text-[#a78bfa] text-xl">MINUTES</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      case 17:
        return (
          <div className="min-h-screen bg-[#4c1d95] text-white p-8">
            <h1 className="text-4xl font-bold text-[#a78bfa] mb-8 text-center">TERMS OF SERVICE & DISCLAIMER</h1>
            <div className="max-w-5xl mx-auto">
              <div className="bg-[#5b21b6] rounded-t-3xl p-8 text-center border-2 border-[#7c3aed]">
                ...
                <p className="text-[#a78bfa] text-lg">Please read carefully before using MandaStrong Studio</p>
              </div>
      ...
      case 18:
        return (
          <div className="min-h-screen bg-[#4c1d95] text-white p-8">
            <h1 className="text-4xl font-bold text-[#a78bfa] mb-8 text-center">AGENT GROK - 24/7 HELP DESK</h1>
            <div className="max-w-6xl mx-auto">
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <div className="bg-[#2e1065] border-2 border-[#7c3aed] rounded-3xl p-8">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="bg-[#5b21b6] w-20 h-20 rounded-full flex items-center justify-center border-2 border-[#a78bfa]">
                      <Bot size={40} className="text-white" />
                    </div>
                    <div>
                      <h3 className="text-3xl font-bold text-white">Agent Grok</h3>
                      <p className="text-[#a78bfa] flex items-center gap-2 font-bold">
                        <span className="w-3 h-3 bg-[#a78bfa] rounded-full inline-block animate-pulse"></span>
                  ...
                  <div className="space-y-4 mb-6 max-h-96 overflow-y-auto">
                    <div className="bg-[#4c1d95] rounded-2xl p-4 border-2 border-[#7c3aed]">
                      ...
                      <p className="text-[#a78bfa]">Hello! I'm Agent Grok, your 24/7 AI assistant for MandaStrong Studio. How can I help you today?</p>
                      <p className="text-xs text-[#a78bfa] mt-2">Just now</p>
                    </div>
                  </div>
                  <div className="space-y-3">
                    <input type="text" placeholder="Type your question..." className="w-full bg-[#4c1d95] border-2 border-[#7c3aed] rounded-2xl px-6 py-4 text-white placeholder-[#a78bfa] outline-none focus:border-[#a78bfa] transition-all font-bold" />
                  ...
                  <div className="bg-[#2e1065] border-2 border-[#7c3aed] rounded-3xl p-8">
                    ...
                    {['AI Services','Rendering Engine','Cloud Storage','24/7 Support'].map(s => (
                      <div key={s} className="flex justify-between items-center mb-3 pb-3 border-b border-[#7c3aed]">
                        ...
                        <span className="text-[#a78bfa] flex items-center gap-2 font-bold">
                          <span className="w-3 h-3 bg-[#a78bfa] rounded-full inline-block animate-pulse"></span>
                          Operational
                        </span>
                      </div>
      ...
      case 19:
        return (
          <div className="min-h-screen bg-[#4c1d95] text-white p-8">
            <h1 className="text-4xl font-bold text-[#a78bfa] mb-8 text-center">COMMUNITY HUB</h1>
            <div className="flex justify-center gap-4 mb-8">
              {['Recent','Popular','Trending'].map(tab => (
                <button key={tab} className={`px-8 py-4 rounded-xl font-bold transition-all border-2 ${tab==='Recent'?'bg-[#5b21b6] text-white border-[#a78bfa]':'bg-[#4c1d95] text-[#a78bfa] border-[#7c3aed]'}`}>
                  {tab}
                </button>
              ))}
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              {[
                ...
                <div key={i} className="bg-[#2e1065] border-2 border-[#7c3aed] rounded-3xl overflow-hidden hover:border-[#a78bfa] transition-all">
                  <div className="bg-black h-48 flex items-center justify-center relative border-b-2 border-[#7c3aed]">
                    <Film size={64} className="text-[#a78bfa]" />
                  </div>
                  <div className="p-6">
                    <h3 className="text-xl font-bold mb-2 text-white">{item.title}</h3>
                    <p className="text-[#a78bfa] text-sm mb-4 font-bold">{item.creator}</p>
                    <div className="flex gap-6 mb-4">
                      <button className="flex items-center gap-2 text-[#a78bfa] hover:text-white transition-all font-bold">
        ...
        return (
          <div className="min-h-screen bg-[#4c1d95] text-white p-8">
            ...
            <div className="max-w-6xl mx-auto bg-[#2e1065] border-2 border-[#7c3aed] rounded-3xl p-12 mb-8">
              ...
              <div className="space-y-6 text-[#a78bfa] text-lg leading-relaxed">
                ...
                <div className="bg-[#5b21b6] rounded-2xl p-8 space-y-5 border-2 border-[#a78bfa]">
                ...
                <p className="text-center text-2xl font-bold text-white mt-8">
                  Visit our fundraiser at <a href="https://MandaStrong1.Etsy.com" target="_blank" rel="noopener noreferrer" className="text-[#a78bfa] hover:text-white underline">MandaStrong1.Etsy.com</a>
                </p>
              </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto bg-[#4c1d95] border-2 border-[#7c3aed] rounded-3xl p-8 mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-[#2e1065] rounded-2xl p-6 border-2 border-[#7c3aed]">
                  ...
                  <p className="text-[#a78bfa]">Browse through pages 4-9 to access 600+ professional AI tools. Each tool board has 120 tools organized in 4 rows. Click any tool to Upload, Paste, or Create With AI.</p>
                </div>
                <div className="bg-[#2e1065] rounded-2xl p-6 border-2 border-[#7c3aed]">
                  <h3 className="text-2xl font-bold text-white mb-3">Step 2: Create Your Content</h3>
                  <p className="text-[#a78bfa]">Use Text-to-Video, Image-to-Animation, Audio-to-Motion tools to create amazing content. All tools support multiple formats and transformations.</p>
                </div>
                <div className="bg-[#2e1065] rounded-2xl p-6 border-2 border-[#7c3aed]">
                  <h3 className="text-2xl font-bold text-white mb-3">Step 3: Upload to Media Library</h3>
                  <p className="text-[#a78bfa]">Page 11 is your Media Library. Upload videos, audio, images. Drag and drop supported. All files are saved automatically.</p>
                </div>
                <div className="bg-[#2e1065] rounded-2xl p-6 border-2 border-[#7c3aed]">
                  <h3 className="text-2xl font-bold text-white mb-3">Step 4: Edit on Timeline</h3>
                  <p className="text-[#a78bfa]">Page 12 Timeline Editor lets you arrange your media. Drag files from library to video, audio, and text tracks. Preview in real-time.</p>
                </div>
                <div className="bg-[#2e1065] rounded-2xl p-6 border-2 border-[#7c3aed]">
                  <h3 className="text-2xl font-bold text-white mb-3">Step 5: Mix Your Audio</h3>
                  <p className="text-[#a78bfa]">Page 13 Audio Mixer gives you professional control over music, voice, sound effects, and master output levels.</p>
                </div>
                <div className="bg-[#2e1065] rounded-2xl p-6 border-2 border-[#7c3aed]">
                  <h3 className="text-2xl font-bold text-white mb-3">Step 6: Configure & Export</h3>
                  <p className="text-[#a78bfa]">Page 14 Settings lets you choose resolution (HD/4K/8K), frame rate, and duration. Then export your masterpiece.</p>
                </div>
                <div className="bg-[#2e1065] rounded-2xl p-6 border-2 border-[#7c3aed]">
                  <h3 className="text-2xl font-bold text-white mb-3">Step 7: Watch & Share</h3>
                  <p className="text-[#a78bfa]">Page 10 Editor's Choice shows your completed movie in a full cinema screen with play controls. Share with the world!</p>
                </div>
                <div className="bg-[#5b21b6] rounded-2xl p-6 border-2 border-[#a78bfa]">
                  <h3 className="text-2xl font-bold text-white mb-3">Need Help? Ask Agent Grok!</h3>
                  <p className="text-[#a78bfa]">Click the Grok button (bottom right) on any page for instant 24/7 help. Agent Grok answers all your questions immediately.</p>
                </div>
              </div>
            </div>
            ...
            <p className="text-[#a78bfa] text-sm text-center font-bold">MandaStrong1 2026 ~ Author Of Doxy The School Bully ~ MandaStrong1@Etsy.com</p>
            <GrokBtn />
          </div>
        );
